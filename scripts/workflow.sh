...
# ngmlr
/usr/bin/time -v ngmlr -t 16 -r ref.fna -q reads.fasta -o ngmlr.sam -x ont
...
picky.pl xls2vcf --re 10 --xls picky.profile.DEL.xls --xls picky.profile.INS.xls --xls picky.profile.CTLC.xls --xls picky.profile.INDEL.xls --xls picky.profile.INV.xls --xls picky.profile.TTLC.xls --xls picky.profile.TDSR.xls --xls picky.profile.TDC.xls > picky.allsv.vcf
